...
.login__footer p {
  ...
  <div class="grid">
    ...
    <form action="conectar.php" method="post" class="form login">
...
.boton6{
     ...
     <p><center>© Copyright 2018.  WFI de México</center></p>
...
<!-- <center><a href="http://localhost/wfijtable/Codes/formulario/index2.php"><button value="Usuario" class="boton6">Usuario</button></a>-->
  </div>
