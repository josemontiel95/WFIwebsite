...
<?PHP
$noaplica= "N/A";		
$sql=mysql_query("SELECT id,Nombre,Puesto,Correo,TelTrabajo,TelEmergencia,imei,usuario,password,cuenta_huawuei,password2,nss,curp,domicilio,id2,certi_medico,cd3_alturas,cd3_pri_auxilios,cd3_ries_electricos,creedenciales_wfi, credenciales_huawuei,comisionamiento,instalacion,pim FROM registros WHERE cuenta_huawuei='N/A'");
